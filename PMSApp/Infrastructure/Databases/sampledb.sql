...
INSERT INTO users (fullname, email, contactnumber, imageurl)
VALUES
    ('John Doe', 'john.doe@example.com', '123-456-7890', 'https://example.com/johndoe.jpg'),
    ('Jane Smith', 'jane.smith@example.com', '987-654-3210', 'https://example.com/janesmith.jpg'),
    ('Alice Johnson', 'alice.johnson@example.com', NULL, 'https://example.com/alice.jpg'),
    ('Bob Williams', 'bob.williams@example.com', '555-123-4567', NULL),
    ('Eva Brown', 'eva.brown@example.com', NULL, NULL),
    ('Michael Davis', 'michael.davis@example.com', '111-222-3333', 'https://example.com/michael.jpg'),
    ('Emily White', 'emily.white@example.com', '999-888-7777', 'https://example.com/emily.jpg'),
    ('David Miller', 'david.miller@example.com', '444-555-6666', 'https://example.com/david.jpg'),
    ('Sophia Taylor', 'sophia.taylor@example.com', NULL, NULL),
    ('Daniel Lee', 'daniel.lee@example.com', '777-666-5555', 'https://example.com/daniel.jpg');


INSERT INTO credentials (username, userid, password)
VALUES
    ('johndoe', 1, 'password123'),
    ('janesmith', 2, 'securepass'),
    ('alicejohnson', 3, 'pass123'),
    ('bobwilliams', 4, 'userpass'),
    ('evabrown', 5, 'evapassword'),
    ('michaeldavis', 6, 'mikepass'),
    ('emilywhite', 7, 'emilypass'),
    ('davidmiller', 8, 'davidpass'),
    ('sophiataylor', 9, 'sophiapass'),
    ('daniellee', 10, 'danielpass');
...
INSERT INTO employees (userid, hiredate, department, position, reportingid, salary)
VALUES
    (1, '2023-01-01', 'HR', 'Manager', NULL, 60000),
    (2, '2023-02-01', 'IT', 'Developer', 1, 50000),
    (3, '2023-03-01', 'Finance', 'Accountant', 1, 55000),
    (4, '2023-04-01', 'IT', 'Tester', 2, 48000),
    (5, '2023-05-01', 'HR', 'Analyst', 1, 52000),
    (6, '2023-06-01', 'Design', 'Designer', 3, 55000),
    (7, '2023-07-01', 'IT', 'Team Lead', 2, 65000),
    (8, '2023-08-01', 'IT', 'Scrum Master', 7, 70000),
    (9, '2023-09-01', 'Product Management', 'Product Owner', NULL, 75000),
    (10, '2023-10-01', 'IT', 'DevOps Engineer', 7, 80000);

INSERT INTO projects (title, startdate, enddate, description, teammanagerid, status)
VALUES
    ('Project 1', '2023-01-01', '2023-02-01', 'Description 1', 2, 'inprogress'),
    ('Project 2', '2023-02-01', '2023-03-01', 'Description 2', 3, 'notstarted'),
    ('Project 3', '2023-03-01', '2023-04-01', 'Description 3', 2, 'completed'),
    ('Project 4', '2023-04-01', '2023-05-01', 'Description 4', 7, 'inprogress'),
    ('Project 5', '2023-05-01', '2023-06-01', 'Description 5', 4, 'completed'),
    ('Project 6', '2023-06-01', '2023-07-01', 'Description 6', 6, 'inprogress'),
    ('Project 7', '2023-07-01', '2023-08-01', 'Description 7', 8, 'notstarted'),
    ('Project 8', '2023-08-01', '2023-09-01', 'Description 8', 10, 'completed'),
    ('Project 9', '2023-09-01', '2023-10-01', 'Description 9', 5, 'inprogress'),
    ('Project 10', '2023-10-01', '2023-11-01', 'Description 10', 1, 'notstarted');


INSERT INTO projectallocations (membership, assigndate, releasedate, status, projectid, employeeid)
VALUES
    ('Full Time', '2023-01-01', NULL, 'yes', 1, 2),
    ('Part Time', '2023-02-01', '2023-03-01', 'no', 2, 4),
    ('Full Time', '2023-03-01', NULL, 'yes', 3, 6),
    ('Part Time', '2023-04-01', '2023-05-01', 'no', 4, 8),
    ('Full Time', '2023-05-01', NULL, 'yes', 5, 10),
    ('Part Time', '2023-06-01', '2023-07-01', 'no', 6, 3),
    ('Full Time', '2023-07-01', NULL, 'yes', 7, 1),
    ('Part Time', '2023-08-01', '2023-09-01', 'no', 8, 7),
    ('Full Time', '2023-09-01', NULL, 'yes', 9, 9),
    ('Part Time', '2023-10-01', '2023-11-01', 'no', 10, 5);


INSERT INTO activitytypes (activitytype)
VALUES
    ('User Story'),
    ('Task'),
    ('Bug'),
...
INSERT INTO activities (title, activitytypeid, priority, description, projectid, assignedto, assignedby, createddate, assigneddate, startdate, duedate, status)
VALUES
    ('Activity 1', 1, 'High', 'Description 1', 1, 2, 7, '2023-01-01', '2023-01-02', '2023-01-03', '2023-01-10', 'inprogress'),
    ('Activity 2', 2, 'Medium', 'Description 2', 2, 4, 9, '2023-02-01', '2023-02-02', '2023-02-03', '2023-02-10', 'todo'),
    ('Activity 3', 3, 'Low', 'Description 3', 3, 6, 1, '2023-03-01', '2023-03-02', '2023-03-03', '2023-03-10', 'completed'),
    ('Activity 4', 4, 'High', 'Description 4', 4, 8, 3, '2023-04-01', '2023-04-02', '2023-04-03', '2023-04-10', 'inprogress'),
    ('Activity 5', 5, 'Medium', 'Description 5', 5, 10, 5, '2023-05-01', '2023-05-02', '2023-05-03', '2023-05-10', 'completed'),
    ('Activity 6', 6, 'Low', 'Description 6', 6, 3, 6, '2023-06-01', '2023-06-02', '2023-06-03', '2023-06-10', 'inprogress'),
    ('Activity 7', 7, 'High', 'Description 7', 7, 1, 8, '2023-07-01', '2023-07-02', '2023-07-03', '2023-07-10', 'todo'),
    ('Activity 8', 8, 'Medium', 'Description 8', 8, 7, 10, '2023-08-01', '2023-08-02', '2023-08-03', '2023-08-10', 'completed'),
    ('Activity 9', 9, 'Low', 'Description 9', 9, 9, 2, '2023-09-01', '2023-09-02', '2023-09-03', '2023-09-10', 'inprogress'),
    ('Activity 10', 10, 'High', 'Description 10', 10, 5, 4, '2023-10-01', '2023-10-02', '2023-10-03', '2023-10-10', 'todo');

INSERT INTO sprints (title, startdate, enddate, goal)
VALUES
    ('Sprint 1', '2023-01-01', '2023-01-10', 'Goal 1'),
    ('Sprint 2', '2023-02-01', '2023-02-10', 'Goal 2'),
    ('Sprint 3', '2023-03-01', '2023-03-10', 'Goal 3'),
    ('Sprint 4', '2023-04-01', '2023-04-10', 'Goal 4'),
    ('Sprint 5', '2023-05-01', '2023-05-10', 'Goal 5'),
    ('Sprint 6', '2023-06-01', '2023-06-10', 'Goal 6'),
    ('Sprint 7', '2023-07-01', '2023-07-10', 'Goal 7'),
    ('Sprint 8', '2023-08-01', '2023-08-10', 'Goal 8'),
    ('Sprint 9', '2023-09-01', '2023-09-10', 'Goal 9'),
    ('Sprint 10', '2023-10-01', '2023-10-10', 'Goal 10');

INSERT INTO sprintactivities (sprintid, activityid)
VALUES
    (1, 1),
    (2, 2),
    (3, 3),
...
INSERT INTO timesheets (timesheetdate, status, statuschangeddate, employeeid)
VALUES
    ('2023-01-01', 'inprogress', '2023-01-01', 2),
    ('2023-02-01', 'submitted', '2023-02-01', 4),
    ('2023-03-01', 'approved', '2023-03-01', 6),
    ('2023-04-01', 'rejected', '2023-04-01', 8),
    ('2023-05-01', 'inprogress', '2023-05-01', 10),
    ('2023-06-01', 'submitted', '2023-06-01', 3),
    ('2023-07-01', 'approved', '2023-07-01', 1),
    ('2023-08-01', 'rejected', '2023-08-01', 7),
    ('2023-09-01', 'inprogress', '2023-09-01', 9),
('2023-01-01', 'inprogress', '2023-10-01', 2);
